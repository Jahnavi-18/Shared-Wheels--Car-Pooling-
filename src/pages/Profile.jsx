...
const Profile = () => {
  ...
  const myrides = useFetch('rides',true);
            ...
            {loading ? (
              ...
              <>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    <DropdownMenuItem>
                      <Label htmlFor="avatar" className="font-normal">
                        Upload image
                      </Label>
          ...
          {!editMode ? (
            <>
              ...
              {/* <div className="flex justify-center items-start flex-col space-y-4 mt-8">
                <h3 className="text-base font-semibold leading-4 text-center md:text-left">
                  About
                </h3>
                ...
                <p className="text-sm text-muted-foreground">
                  {data?.age && `${data?.age} y/o`}
                </p>
                <p className="text-sm text-muted-foreground">
                  {myrides?.data?.length} Rides published
                </p>
                <p className="text-sm text-muted-foreground">
            ...
            >
              ...
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <Textarea placeholder="Bio" id="bio" {...field} />
                )}
              />
          ...
          <div className="flex justify-between items-center w-full">
            ...
            <Pencil
              className={`cursor-pointer p-1 rounded-lg ${
                rideDeleteMode && "bg-primary text-primary-foreground"
              } `}
              size={25}
